...
\begin{figure}
	...
	\end{center}
\caption{Correlation of RSA model predictions (x axis) and the empirically elicited proportion of target selections. Data points are color coded according to the conditions in Figure~\ref{modelcompr-results}.} 
