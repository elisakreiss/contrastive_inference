    ...
    interactiveExperimentLobby: function(config) {
        const _lobby = {
            ...
            render: function(CT, magpie) {
                ...
                let fillImage = function(div, image, type, intended_target) {
                ...
                let setUpOneRound = function(images) {
                    ...
                    for (let [type, img] of Object.entries(images)) {
                        if (type == "target" | type == "firstDistractor" | type == "secondDistractor" | type == "thirdDistractor") {
                            fillImage(color_divs[magpie.indices[count]], img, type, images.intended_target);
                            count += 1;
                        }
                    }
                            ...
                            div.onclick = (e) => {
                                ...
                                if (magpie.speaker_chat.length >= 1 & first_click) {
                                    ...
                                    const trial_data = {
                                        ...
                                        condition: images.condition,
                                        targetcompColor: images.targetcompColor,
                                        targetType: images.targetType,
                                        compType: images.compType,
                                        contrast_present: images.contrast,
                                        contrastType: images.contrastType,
                                        contrastColor: images.contrastColor,
                                        distractorColor: images.distractorColor,
                                        distractorType: images.distractorType,
                                        intended_target: images.intended_target,
