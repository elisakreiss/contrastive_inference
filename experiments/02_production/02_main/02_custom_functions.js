...
const retrieve_contexts = function() {
    ...
    function completeContext (targetcompColor, targetType, compType, contrast, targetTypicality, compTypicality) {
        ...
        var context = {
            ...
            firstDistractor: targetcompColor + "_" + compType + ".png",
            secondDistractor: contrastColor + "_" + contrastType + ".png",
            thirdDistractor: distractorColor + "_" + distractorType + ".png"
        };
            ...
            while (context_found == false) {
                ...
                if (current_context.condition == condition_list[cond_id] & 
                    ...
                    if (condition_list[cond_id].includes("p") & num > 1) {
                        current_context.intended_target = "firstDistractor";
                    }
    ...
    // for (var num in [0,1]) {
        ...
        while (context_found == false) {
            ...
            if (current_context.condition.includes("p") & 
                ...
                current_context.selected = true;
                current_context.intended_target = "secondDistractor";
                sampled_contexts.push(current_context);
                context_found = true;
            }
            context_id += 1;
    ...
    // for (var num in [0,1]) {
        ...
        while (context_found == false) {
            ...
            if (current_context.selected == false) {
                ...
                current_context.selected = true;
                current_context.intended_target = "thirdDistractor";
                sampled_contexts.push(current_context);
                context_found = true;
            }
            context_id += 1;
...
const color_ref_utils = {
    ...
    sampleImages: function() {
        // for main experiment
        var contexts = _.shuffle(retrieve_contexts());
