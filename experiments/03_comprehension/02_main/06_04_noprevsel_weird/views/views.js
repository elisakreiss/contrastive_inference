...
var priorManipulation = {
  ...
  render: function () {
    ...
    var text2 = 'You know that <strong>she likes WEIRD things</strong> and she generally prefers them over normal things whenever possible. But since it\'s a "prude and freaky" theme, she will sometimes also ask you to get some normal things.';
    ...
    $("#next").on("click", function() {
      ...
      } else if ((opt1_checked & options[0] != "weird")
      | (opt2_checked & options[1] != "weird")
      | (opt3_checked & options[2] != "weird")
      | (opt4_checked & options[3] != "weird")) {
...
var main = {
  ...
  render: function (CT) {
    ...
    // elicit prior adjective preference
    // var allUtts = [' ...'];
    // don't elicit prior adjective preference
    var allUtts = [];
    ...
    $('#next_context').on('click', function () {
      ...
      var rt2;
      if (contextInfo.utterance === "modified") {
        item2 = selectedItemsAll[1].join()
        rt2 = reactionTimes[1].join()
      } else {
        item2 = "NaN"
        rt2 = "NaN"
      }
      var trialData = {
        ...
        selectedItem1: selectedItemsAll[0].join(),
        selectedItem2: item2,
        // reaction_time_prior: reactionTimes[0].join(),
        reaction_time1: reactionTimes[0].join(),
        reaction_time2: rt2,
        RT: Date.now() - initialStartingTime
      };
      exp.trial_data.push(trialData);
