...
var intro = {
    ...
    // introduction text
    text:
        "Thank you for participating in our study. In this study, you will be asked to name 3 things that come to mind when you imagine a certain object. It will approximately take 3 minutes.<br>Please only participate once in this series of HITs.<br>Please disable adblock.",
    legal_info:
...
var example = {
    ...
    // text
    text:
        "You will see different objects. For each object, please name 3 things that come to mind when you imagine it. <br>Here is an example response for <strong>dime</strong>.",
...
var main = {
    ...
    render: function(CT) {
        ...
        $("#main").html(
            Mustache.render(viewTemplate, {
                question: "List 3 things that come to mind when you imagine" + article + " <strong>" + exp.trial_info.main_trials[CT] + "</strong>!"
            })
        );
