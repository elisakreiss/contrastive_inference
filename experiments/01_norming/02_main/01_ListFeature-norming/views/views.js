var intro = {
    ...
    // introduction text
    text:
        "Thank you for participating in our study. In this study, you will be asked to name the color that first comes to mind for a certain object. It will approximately take <strong>???</strong> minutes.",
    legal_info:
...
var example = {
    ...
    // text
    text:
        "In each trial, you are asked to name the first 3 perceptual features that come to mind when you imagine a certain object. Here is an example response for <strong>dime</strong>.",
...
var main = {
    ...
    render: function(CT) {
        ...
        $("#main").html(
            Mustache.render(viewTemplate, {
                question: "List 3 perceptual features that describe " + article + " <strong>" + exp.trial_info.main_trials[CT] + "</strong>!"
            })
        );
        ...
        $("#next").on("click", function() {
            ...
            var trial_data = {
                ...
                feature2: $("#feature3-response").val(),
                obj_unknown: document.getElementById("unknown-obj").checked
            };
