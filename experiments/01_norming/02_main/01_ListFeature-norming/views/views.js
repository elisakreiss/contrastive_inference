...
var intro = {
    ...
    // introduction text
    text:
        "Thank you for participating in our study. In this study, you will be asked to name 3 perceptual features that come to mind when you imagine a certain object. It will take approximately 20-25 minutes.<br>Please only participate once in this series of HITs.",
    legal_info:
...
var main = {
    ...
    render: function(CT) {
        ...
        // define article
        var mass_nouns = ["garlic","broccoli","cotton candy","corn","lettuce","scissors","soap","toilet paper"];
