...
var intro = {
    ...
    // introduction text
    text:
        "Thank you for participating in our study. In this study, you will be asked to name the color that first comes to mind for a certain object. It will approximately take <strong>???</strong> minutes.<br>Please only participate once in this series of HITs.",
    legal_info:
...
var main = {
    ...
    render: function(CT) {
        ...
        $("#main").html(
            Mustache.render(viewTemplate, {
                question: "Name the color that first comes to mind when you imagine " + article + " <strong>" + exp.trial_info.main_trials[CT] + "</strong>!"
            })
        );
        ...
        $("#next").on("click", function() {
            ...
            var trial_data = {
                ...
                option_chosen: $("#color-response").val(),
    ...
    //
    // TODO: remember to adapt trial number
    //
    trials: 18
};
